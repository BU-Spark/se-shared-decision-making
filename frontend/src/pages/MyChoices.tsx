    ...
    <Layout>
      ...
      >
        ...
        <Grid item xl={5} lg={5} md={5} sx={{ alignItems: "center" }}>
          <Typography variant="h2" color={textColor} fontWeight="500">
        ...
        <Grid
          ...
          lg={12}
          md={12}
          sx={{ alignItems: "center", justifyContent: "center", pt: 6, pb: 8 }}
        >
          <Grid
            container
            item
      ...
      <Grid container xl={12} lg={12} md={12} sx={{ alignItems: "center" }}>
        <Grid item>
      ...
      <Grid
        ...
        lg={8}
        md={8}
        sx={{ p: 0.2, backgroundColor: lightGreen }}
      ></Grid>
    </Layout>
  );
};
