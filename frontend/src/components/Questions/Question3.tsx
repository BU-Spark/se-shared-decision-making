...
const Question3 = () => {
  ...
  const handleSliderChange = (
    ...
    dispatch(addToCategory({ category, questionText: "Less time in the hospital and fewer interventions" }));
  };
  ...
  return (
    <Layout>
      <div className="question-number-circle">3</div>
        <div>
            <h3 className="imp">HOW IMPORTANT IS ...</h3>
            <h2 className="QuestionText">Less time in the hospital and</h2>
            <h2 className="QuestionText">fewer interventions</h2>
        </div>
