...
class RemoteStrapiDestinationProvider {
    ...
    async bootstrap() {
        ...
        if (!auth) {
            ws = await __classPrivateFieldGet(this, _RemoteStrapiDestinationProvider_instances, "m", _RemoteStrapiDestinationProvider_connectToWebsocket).call(this, wsUrl);
        }
        // Common token auth, this should be the main auth method
        else if (auth.type === 'token') {
            const headers = { Authorization: `Bearer ${auth.token}` };
            ws = await __classPrivateFieldGet(this, _RemoteStrapiDestinationProvider_instances, "m", _RemoteStrapiDestinationProvider_connectToWebsocket).call(this, wsUrl, { headers });
        }
...
}, _RemoteStrapiDestinationProvider_connectToWebsocket = async function _RemoteStrapiDestinationProvider_connectToWebsocket(address, options) {
