...
const D = (n) => g(B, {
  ...
  N(() => {
    ...
    e.length === 0 || e.length === 1 && b(e).length !== 0 || e.length > 1 && Boolean(e.find((t) => t.tagName !== "BUTTON")) ? (s.current.setAttribute("tabIndex", !r && i ? "0" : "-1"), e.forEach((t, o) => {
  ...
  const d = v(() => {
    const e = u(s.current, !0);
    e.length >= 1 && (b(e).length !== 0 || !e.find((t) => t.tagName !== "BUTTON")) && l(!0), m({
      rowIndex: n.row - 1,
      colIndex: n.col - 1
    });
  }, [n, m]);
