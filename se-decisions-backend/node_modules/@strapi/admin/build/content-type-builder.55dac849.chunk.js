"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[8880],{25747:function(Ae,ne,g){var a=g(32735),j=g(83292),ye=g(60216),$=g.n(ye),R=g(39161),l=g.n(R),P=g(57269),V=g.n(P),Ze=g(13478),n=g.n(Ze);const q={biginteger:P.Number,boolean:P.Boolean,collectionType:P.CollectionType,component:P.Component,contentType:P.CollectionType,date:P.Date,datetime:P.Date,decimal:P.Number,dynamiczone:P.DynamicZone,email:P.Email,enum:P.Enumeration,enumeration:P.Enumeration,file:P.Media,files:P.Media,float:P.Number,integer:P.Number,json:P.Json,JSON:P.Json,media:P.Media,number:P.Number,password:P.Password,relation:P.Relation,richtext:P.RichText,singleType:P.SingleType,string:P.Text,text:P.Text,time:P.Date,timestamp:P.Date,uid:P.Uid},be=(0,j.default)(R.Box)`
  svg {
    height: 100%;
    width: 100%;
  }
`,ke=({type:we,customField:Ce,...d})=>{const Me=(0,Ze.useCustomFields)();let We=q[we];if(Ce){const{icon:O}=Me.get(Ce);O&&(We=O)}return q[we]?a.createElement(be,{height:(0,Ze.pxToRem)(24),width:(0,Ze.pxToRem)(32),shrink:0,...d,"aria-hidden":!0},a.createElement(R.Box,{as:We})):null};ke.defaultProps={customField:null},ke.propTypes={type:$().string.isRequired,customField:$().string},ne.Z=ke},74753:function(Ae,ne,g){var a=g(32735);const j=(0,a.createContext)();ne.Z=j},51216:function(Ae,ne,g){var a=g(32735);const j=(0,a.createContext)();ne.Z=j},198:function(Ae,ne,g){var a=g(32735),j=g(74753);const ye=()=>(0,a.useContext)(j.Z);ne.Z=ye},32237:function(Ae,ne,g){var a=g(32735),j=g(51216);const ye=()=>(0,a.useContext)(j.Z);ne.Z=ye},97165:function(Ae,ne,g){g.r(ne),g.d(ne,{default:function(){return To}});var a=g(32735),j=g(5141),ye=g(99357),$=g(5636),R=g(13478),l=g(39161),P=g(3633),V=g(25158),Ze=g(60216),n=g.n(Ze),q=g(92891),be=g(4409),ke=g(13055),we=g(74753),Ce=g(32237),d=g(92318),Me=g(37087),We=g(33795),O=g.n(We),An=g(23973),Zn=g.n(An),Fn=g(3040),Sn=g.n(Fn),qn=g(59578),Pe=g.n(qn),Ee=g(198),Nn=g(23940),he=g.n(Nn);const Ln=[{label:"All",children:[{label:"images (JPEG, PNG, GIF, SVG, TIFF, ICO, DVU)",value:"images"},{label:"videos (MPEG, MP4, Quicktime, WMV, AVI, FLV)",value:"videos"},{label:"audios (MP3, WAV, OGG)",value:"audios"},{label:"files (CSV, ZIP, PDF, Excel, JSON, ...)",value:"files"}]}],He=({intlLabel:e,name:t,onChange:o,value:s})=>{const{formatMessage:r}=(0,$.useIntl)(),i=s===null||s.length===0?r({id:"global.none",defaultMessage:"None"}):[...s].sort().map(c=>he()(c)).join(", "),u=e.id?r({id:e.id,defaultMessage:e.defaultMessage}):t;return a.createElement(l.MultiSelectNested,{id:"select1",label:u,customizeContent:()=>i,onChange:c=>{c.length>0?o({target:{name:t,value:c,type:"allowed-types-select"}}):o({target:{name:t,value:null,type:"allowed-types-select"}})},options:Ln,value:s||[]})};He.defaultProps={value:null},He.propTypes={intlLabel:n().shape({id:n().string.isRequired,defaultMessage:n().string.isRequired,values:n().object}).isRequired,name:n().string.isRequired,onChange:n().func.isRequired,value:n().oneOfType([n().object,n().array])};var In=He,Dt=e=>e.kind==="collectionType"&&(e.restrictRelationsTo===null||Array.isArray(e.restrictRelationsTo)&&e.restrictRelationsTo.length>0),ze=g(25747),Fe=g(83292),kt=(0,Fe.default)(l.Box)`
  width: 100%;
  height: 100%;
