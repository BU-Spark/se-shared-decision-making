(self["webpackChunkse_decisions_backend"] = self["webpackChunkse_decisions_backend"] || []).push([[8853],{
...
const Roles = () => {
  ...
  ), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: `/settings/${src_pluginId/* default */.Z}/roles/:id`, component: ProtectedEditPage, exact: true }), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: `/settings/${src_pluginId/* default */.Z}/roles`, component: ProtectedListPage, exact: true }), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: "", component: helper_plugin_esm.NotFound })));
};
